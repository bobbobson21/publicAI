...
This AI system come with a set of tools that allows you to make AIs really fast and it also makes your AI much smarter which makes the tools very important and useful to AI development with public AI. A list of these tools (in the order they should most likely be used) is bellow:
 ...
 - TextStrip --Give it the result from the InfoAdded (or just any old file) and it will strip away all charters that can not be found on your standered keybord which is vey useful for files med with web content 
 ...
 - TagGrouping --give it a list of tags and it will output a tags file in pal data and it can also modify infomodel file data to use those tag groups which makes AIs able to understand more
